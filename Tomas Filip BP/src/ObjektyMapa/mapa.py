...
class Mapa:
    ...
    def updateZoom(self):
        ...
        #koef = self.zoom/900
        self.zoom += int(round(self.zoomZotrvacnost*0.2))
        if self.zoom < 32:
            self.zoom = 32
            self.zoomZotrvacnost = 0
        if self.zoom > 386:
    ...
    def nacitajPolicka(self,hrac,casNaNacitanie, celkovyCasNacitavania = 0,cisloNacitania = 0):
        ...
        if celkovyCasNacitavania > casNaNacitanie:
            return
        ...
        casNacitavania = celkovyCasNacitavania
        pom = time.time()
        ...
        pocetNacitanychPolicok = cisloNacitania + 1
        fps = self.hra.dajFPS()
        if fps<60:
            self.pauzaNaTickov = int((60-fps)/10)+1
        ...
        #if casNacitavania >= 0.0025:
        #    self.pauzaNaTickov += 1
        #elif casNacitavania < 0.0012:
        self.nacitajPolicka(hrac,casNaNacitanie, casNacitavania,pocetNacitanychPolicok)
